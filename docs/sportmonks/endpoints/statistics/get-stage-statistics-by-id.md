...
```javascript
https://api.sportmonks.com/v3/football/statistics/stages/{stageId}
```
  ...
  "data": [
       {
        ...
        },
        {
            ...
            "value": {
                ...
                "percentage": 7.11,
                "participant_id": 4358,
                "participant_name": "Kırklarelispor",
                "participant_count": 6
            }
        },
        {
...
- [Stage](https://docs.sportmonks.com/football/endpoints-and-entities/endpoints/stages)
